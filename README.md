...
Using DGS Framework (Netflix) 

- Rest services ready to be implemented

## Start Guide

Run gradle

In apollo dir execute "npm run start"

Open http://localhost:8082/graphql for Apollo playground

### Reference Documentation

For further reference, please consider the following sections:

* [DGS (Netflix)](https://netflix.github.io/dgs/getting-started/)
